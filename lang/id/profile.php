...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used by the Profile Message
    ...
    */
    ...
    'buttons' => [
        'send_verification' => 'Klik di sini untuk mengirim ulang email verifikasi.',
    ],
    ...
    'messages' => [
        ...
        'saved' => 'Anda telah menyimpan perubahan.',
    ],
